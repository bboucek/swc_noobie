...
carpentry: "Bruce's Basement"    # what kind of Carpentry (must be either "lc" or "dc" or "swc")
venue: "Brown"        # brief name of host site without address (e.g., "Euphoric State University")
address: "10 Prospect St."      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
startdate: over      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
